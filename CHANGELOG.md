...
- Published `fda-data-mcp` npm wrapper package built on top of `mcp-remote`.
...
- Updated the README to treat `npx -y fda-data-mcp` as the live install path for stdio clients.
